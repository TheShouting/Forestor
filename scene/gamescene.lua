...
function gamescene:start()
	...
	self:addwidget( {x=0, y=0, w=self.width/4, h=self.height, ax=0, ay=0, aw=0, ah=0,
			input=function(self) self.world.input(-1, 0) end, key="left"} )
	self:addwidget( {x=0, y=0, w=self.width, h=self.height/4, ax=0, ay=0, aw=0, ah=0,
			input=function(self) self.world.input(0, -1) end, key="up"} )
	self:addwidget( {x=0, y=0, w=self.width/4, h=self.height, ax=1, ay=0, aw=1, ah=0,
			input=function(self) self.world.input(1, 0) end, key="right"} )
	self:addwidget( {x=0, y=0, w=self.width, h=self.height/4,ax=0, ay=1, aw=0, ah=1,
